...
| **apiVersion**       | string                    | killbill-api version                |
| **platformVersion**  | string                    | killbill-platform version           |
| **commonVersion**    | string                    | killbill-commons version            |
| **pluginApiVersion** | string                    | killbill-plugin-api version         |
| **pluginInfos**      | List of PluginInfo | Information about plugins on a node |
