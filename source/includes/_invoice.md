...
**billingPeriod**: possible values are defined in [BillingPeriod](https://github.com/killbill/killbill-api/blob/master/src/main/java/org/killbill/billing/catalog/api/BillingPeriod.java).
