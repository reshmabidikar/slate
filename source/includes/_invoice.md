...
An `Invoice` resource represents an invoice. The attributes contained in this resource are the following:

| Name | Type | Generated by | Description |
| ---- | -----| -------- | ------------ |
| **accountId** | string | system | UUID for the account |
| **invoiceId** | string | system | UUID for the invoice |
| **amount** | number | user or system | Sum of all current item amounts |
...
| **invoiceNumber** | number | system | Invoice serial number |
...
**linkedInvoiceItemId**: This ID is used to link to another item -- e.g `ITEM_ADJ` item would link to the item being adjusted.
...
Create an invoice run for the associated `Account`. This may result in the creation of a new `Invoice` if there was anything to invoice for, or nothing, if the account was up to date.
