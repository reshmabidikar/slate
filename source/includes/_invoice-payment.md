...
| **authAmonunt** | number | user or system | Total authorized amount |
| **capturedAmonunt** | number | user or system  | Total captured amount |
| **purchasedAmonunt** | number | user or system | Total purchased amount |
| **refundedAmount** | number | user or system | Total refunded amount |
| **creditedAmount** | number | user or system | Total credited amount (see note below) |
| **currency** | string | user | currency to be used |
| **paymentMethod** | string | system | UUID for the payment method used |
| **transactions** | list | system | list of paymentTransactions, if any |
| **paymentAttempts** | list | system | list of paymentAttempts, if any |
| **auditLogs** | list | system | audit event logs, if any |
